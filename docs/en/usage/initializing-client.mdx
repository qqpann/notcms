...
1. **Generated schema** - Run `npx notcms init` to generate for the first time or `npx notcms pull` to update your schema
...
<AccordionGroup>
  ...
  <Accordion title="Schema not found">
    - Run `npx notcms pull` to generate schema
  ...
  <Accordion title="TypeScript errors">
    ...
    - Regenerate schema with `npx notcms pull`
